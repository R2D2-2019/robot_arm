...
namespace r2d2::robot_arm {
    ...
    public:
         ...
         * @detailed
         * Creates a calculate_inverse_kinematics_c object. This can be used to calculate angles for a robot arm with 2 joints.
         ...
         * Position is given.
         * @detailed
         * This function calculates the angles for the servo's that control the 2 joints of the robot arm. The results get saved within this class.
         * @param vector3i_c coordinate - The coordinates where the end effector has to go. Int x and int y areused for the position. Int z is not used.
         */
         ...
         * @detailed
         * Get the angle of theta. This angle can be calculated using the set_position_end_effector() method from this class.
         ...
         * @detailed
         * Get the angle of beta. This angle can be calculated using the set_position_end_effector() method from this class.
         ...
         * @detailed
         * Get the coordinates of the end effector. Tot garranteed to work when the arm has been controlled outside this class.
