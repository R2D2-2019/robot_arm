...
namespace r2d2::robot_arm {
    uarm_swift_c::uarm_swift_c(const r2d2::hardware_usart_c &usart_bus)
    ...
    void uarm_swift_c::move_joint(const int &joint_id, const int &angle) {
    }

    void uarm_swift_c::move_head_to_coordinate(const vector3i_c &coordinate,
                                               const int speed) {
